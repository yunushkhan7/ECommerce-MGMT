...
@Component({
  selector: 'app-vendors-supplier-add',
  templateUrl: './vendors-supplier-add.component.html',
  styleUrls: ['./vendors-supplier-add.component.scss']
})
export class VendorsSupplierAddComponent implements OnInit {
