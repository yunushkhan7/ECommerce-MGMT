...
@Component({
  selector: 'app-vendors-supplier-list',
  templateUrl: './vendors-supplier-list.component.html',
  styleUrls: ['./vendors-supplier-list.component.scss']
})
export class VendorsSupplierListComponent implements OnInit {
