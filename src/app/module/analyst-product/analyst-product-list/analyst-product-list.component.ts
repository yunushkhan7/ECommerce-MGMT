...
@AutoUnsubscribe()
@Component({
  selector: 'app-analyst-product-list',
  templateUrl: './analyst-product-list.component.html',
  styleUrls: ['./analyst-product-list.component.scss']
})
export class AnalystProductListComponent implements OnInit {
